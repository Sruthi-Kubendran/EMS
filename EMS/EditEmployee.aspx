...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>    Edit Employee</h1>
    <p>    Enter Employee ID<asp:TextBox ID="TextBoxEmpID" runat="server" CausesValidation="True"></asp:TextBox>
&nbsp;<asp:Button ID="ButtonGetEmpById" runat="server" ForeColor="Blue" OnClick="ButtonGetEmpById_Click" Text="Search" ValidationGroup="SearchGroup" />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="TextBoxEmpID" ErrorMessage="RequiredFieldValidator" ValidationGroup="SearchGroup">Employee Id required</asp:RequiredFieldValidator>
    </p>
<table>
        <tr>
            <td>Name</td>
        ...
        <tr>
            ...
            <td style="width: 46px">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="TextBoxCommission" ErrorMessage="RequiredFieldValidator" ValidationGroup="UpdateGroup">Commision required</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>JobTitle</td>
        ...
        <tr>
            <td></td>
            <td style="width: 205px">
                <asp:Button ID="ButtonUpdate" runat="server" Text="Update" CssClass="bg-primary" OnClick="ButtonUpdate_Click" CausesValidation="False" />
            </td>
            <td style="width: 46px">
